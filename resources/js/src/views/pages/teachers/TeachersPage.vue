          ...
          <!-- <template #cell(role)="data">
            ...
            <template #cell(status)="data">
             ...
             <template #cell(office)="data">
               ...
               <b class="italic" > {{ data.item.office }} </b> 
            ...
            <template #cell(actions)="data">
              ...
              >
                ...
                <b-dropdown-item :to="{ name: 'teachers-home-view', params: { id: data.item.teaId } }">
                  <feather-icon icon="FileTextIcon" />
                  <span class="align-middle ml-50">View Details</span>
                </b-dropdown-item>
    
                <b-dropdown-item :to="{ name: 'teachers-home-edit', params: { id: data.item.teaId } }">
                  <feather-icon icon="EditIcon" />
                  <span class="align-middle ml-50">Edit Teacher </span>
                </b-dropdown-item>

                <!-- v-if="userData.permissions.teacher.edit === false" -->
                <b-dropdown-item :to="{ name: 'timetables-home', params: { teacher: data.item.teaId } }">
                  <feather-icon icon="Maximize2Icon" />
                  <span class="align-middle ml-50">View His/Her Timetable</span>
                </b-dropdown-item>  
