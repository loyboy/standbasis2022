          ...
          <!-- <template #cell(role)="data">
            ...
            <template #cell(actions)="data">
              ...
              >    
                ...
                <b-dropdown-item :to="{ name: 'calendars-home-view', params: { id: data.item.calendarId } }">
                  <feather-icon icon="FileTextIcon" />
                  <span class="align-middle ml-50">View Details</span>
                </b-dropdown-item>
    
                <b-dropdown-item v-if=" userData.role === 'admin' " :to="{ name: 'calendars-home-edit', params: { id: data.item.calendarId } }">
