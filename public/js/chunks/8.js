...
/* harmony import */ var _core_components_app_auto_suggest_useAutoSuggest__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @core/components/app-auto-suggest/useAutoSuggest */ "./resources/js/src/@core/components/app-auto-suggest/useAutoSuggest.js");
...
/* harmony import */ var _search_and_bookmark_data__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../search-and-bookmark-data */ "./resources/js/src/@core/layouts/components/app-navbar/search-and-bookmark-data.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props) {
    ...
    var _$themeConfig$app = _themeConfig__WEBPACK_IMPORTED_MODULE_5__["$themeConfig"].app,
        ...
        appLogoImageLight = _$themeConfig$app.appLogoImageLight;
    return {
      ...
      // App Name
      appName: appName,
      appLogoImageLight: appLogoImageLight
    };
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    return {
      ...
      checkPermmission: _core_layouts_utils__WEBPACK_IMPORTED_MODULE_0__["checkPermmission"]
    };
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    logout: function logout() {
      ...
      localStorage.removeItem(_auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_3__["default"].jwtConfig.storageRefreshTokenKeyName); // Remove userData from localStorage

      localStorage.removeItem('userData'); // Reset ability

      this.$ability.update(_libs_acl_config__WEBPACK_IMPORTED_MODULE_4__["initialAbility"]); // Redirect to login page
    ...
    _c(
      ...
      [
        ...
        _c(
          ...
          {
            staticClass: "ml-25",
            attrs: { href: "https://plenti.africa", target: "_blank" },
          },
          [_vm._v("Plenti Africa")]
        ),
        _vm._v(" "),
        ...
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: _vm.checkPermmission(item.permission),
            expression: "checkPermmission(item.permission)",
          },
        ],
      ...
      _c(
        ...
        [
          _c(
            ...
            [
              _vm._v(" "),
              _vm.isMerchant === true || _vm.isAdmin === true
                ? _c(
                    "b-dropdown-item",
                    {
                      attrs: {
...
/* harmony import */ var _core_layouts_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @core/layouts/utils */ "./resources/js/src/@core/layouts/utils.js");
...
function useVerticalLayout(navbarTypeOld, footerType) {
  var navbarType = "Sticky";
...
/*!*************************************************!*\
  !*** ./resources/js/src/@core/layouts/utils.js ***!
  \*************************************************/
/*! exports provided: resolveVerticalNavMenuItemComponent, resolveHorizontalNavMenuItemComponent, checkPermmission, resolveNavDataRouteName, isNavLinkActive, isNavGroupActive, navLinkProps */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkPermmission", function() { return checkPermmission; });
...
var checkPermmission = function checkPermmission(item) {
  var user = Object(_auth_utils__WEBPACK_IMPORTED_MODULE_3__["getUserData"])();
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./resources/js/src/@core/libs/acl/utils.js");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "useUtils", function() { return useUtils; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_", function() { return _; });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./resources/js/src/@core/libs/i18n/utils.js");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./resources/js/src/@core/utils/utils.js");
...
/*!***********************************************!*\
  !*** ./resources/js/src/@core/utils/utils.js ***!
  \***********************************************/
/*! exports provided: isObject, isToday, getRandomBsVariant, isDynamicRouteActive, useRouter, paginateArray, sortCompare, getRandomInt, randomDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
module.exports = "/images/_/_/_/_/plenti/resources/js/src/assets/images/flags/de.png";
...
module.exports = "/images/_/_/_/_/plenti/resources/js/src/assets/images/flags/en.png";
...
module.exports = "/images/_/_/_/_/plenti/resources/js/src/assets/images/flags/fr.png";
...
module.exports = "/images/_/_/_/_/plenti/resources/js/src/assets/images/flags/pt.png";
...
module.exports = "/images/_/_/_/_/plenti/resources/js/src/assets/images/icons/jpg.png";
...
module.exports = "/images/_/_/_/_/plenti/resources/js/src/assets/images/icons/pdf.png";
